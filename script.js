document.getElementById('startGame').addEventListener('click', function startGame(){
  ...
  var allEnemies = [
    ...
    { width: 20, height: 20, x: 155, y: 30, orientation: "right"},
    { width: 20, height: 20, x: 1090, y: 90, orientation: "left"},
    ...
    { width: 20, height: 20, x: 600, y: 335, orientation: "down"},
    { width: 20, height: 20, x: 660, y: 335, orientation: "down"},
    ...
    { width: 20, height: 20, x: 1090, y: 470, orientation: "left"},
